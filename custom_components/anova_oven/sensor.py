...
def sensor_descriptions(
    ...
    return [
        ...
        AnovaOvenSensorEntityDescription(
            ...
            value_fn=lambda data: temp_getter(data.sensor.nodes.temperature_bulbs.wet.temperature),
            extra_state_attributes={},
        ),
        AnovaOvenSensorEntityDescription(
            key="wet_bulb_target_temperature",
            translation_key="wet_bulb_target_temperature",
            native_unit_of_measurement=unit_of_temperature,
            device_class=SensorDeviceClass.TEMPERATURE,
            state_class=SensorStateClass.MEASUREMENT,
            value_fn=lambda data: temp_getter(data.sensor.nodes.temperature_bulbs.wet.target_temperature),
            extra_state_attributes={},
        ),
        AnovaOvenSensorEntityDescription(
            key="dry_bulb_temperature",
            translation_key="dry_bulb_temperature",
            native_unit_of_measurement=unit_of_temperature,
            device_class=SensorDeviceClass.TEMPERATURE,
            state_class=SensorStateClass.MEASUREMENT,
            value_fn=lambda data: temp_getter(data.sensor.nodes.temperature_bulbs.dry.temperature),
            extra_state_attributes={},
        ),
        AnovaOvenSensorEntityDescription(
            key="dry_bulb_target_temperature",
            translation_key="dry_bulb_target_temperature",
            native_unit_of_measurement=unit_of_temperature,
            device_class=SensorDeviceClass.TEMPERATURE,
            state_class=SensorStateClass.MEASUREMENT,
            value_fn=lambda data: temp_getter(data.sensor.nodes.temperature_bulbs.dry.target_temperature),
            extra_state_attributes={},
        ),
